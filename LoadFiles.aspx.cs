...
{
    public partial class LoadFiles : System.Web.UI.Page
    {
        private string connectionString = "Data Source=Azure-SQL;Initial Catalog=PharmCAS;Integrated Security=True";
            ...
            try
            {
                ...
                using (SqlConnection cnn = new SqlConnection(connectionString))
                {
                    ...
                    //foreach (string line in lines)
                    {
                        ...
                        SQLcmd += " @Name='" + values[0] + "'";
                        SQLcmd += ", @ID='" + values[1].Replace("'", "''") + "'";
                        SQLcmd += ", @Street='" + values[2].Replace("'", "''") + "'";
                        SQLcmd += ", @City='" + values[3] + "'";
                        SQLcmd += ", @Zip='" + values[4] + "'";
                        SQLcmd += ", @ST='" + values[5] + "'";
                        SQLcmd += ", @DOB='" + values[6] + "'";
                        SQLcmd += ", @EntryDate='" + values[7] + "'";
                        SQLcmd += ", @Phone='" + values[8].Replace("'", "''") + "'";
                        SQLcmd += ", @Sex='" + values[9] + "'";

                        SQLcmd += ", @GradYearMo='" + values[10] + "'";
                        SQLcmd += ", @Ethnic='" + values[11] + "'";
                        SQLcmd += ", @Cit='" + values[12].Replace("'", "''") + "'";
                        SQLcmd += ", @Dept='" + values[13] + "'";
                        SQLcmd += ", @Div='" + values[14] + "'";
                        SQLcmd += ", @Camp='" + values[15] + "'";
                        SQLcmd += ", @Lvl='" + values[16].Replace("'", "''") + "'";
                        SQLcmd += ", @Program='" + values[17] + "'";
                        SQLcmd += ", @Advisor='" + values[18].Replace("'", "''") + "'";
                        SQLcmd += ", @EMail='" + values[19] + "'";

                        SQLcmd += ", @F21='" + values[20] + "'";
                        SQLcmd += ", @F22='" + values[21] + "'";
                        SQLcmd += ", @OtherPID='" + values[22] + "'";
                        SQLcmd += ", @F24 ='" + values[23] + "'";
                        using (SqlCommand cmd = new SqlCommand(SQLcmd, cnn))
                        {
                            if (RowCount > 1)
                            {
        ...
        public string CleanAString(string strInput)
        {
            ...
            C1 = ",";
            //string commaSubstitute = ((char)126).ToString();  //tilde ~
            ...
            for (int i = 0; i < workLine.Length; i++)
            {
                ...
                //if (workLine.Substring(i, 1) == "")
                //if(workLine.Substring(1,1) == ((char)34).ToString())
                //if (int()workLine.Substring(1, 1) == 34)
                {
                    if (endquoteFlag == "Y")
                    {
                        endquoteFlag = "";
